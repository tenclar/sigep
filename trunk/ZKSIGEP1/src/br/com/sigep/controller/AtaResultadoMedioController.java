...
public class AtaResultadoMedioController extends GenericForwardComposer{
	...
	public void onClick$gerarPdfMedio(Event e) throws InterruptedException, JRException {
		
		String caminho, saida, jasper;
		
		caminho = application.getRealPath("/Relatorios/AtaResultadoEnsinoMedio.jrxml");
		saida = "D:/Arquivos da Faculdade/Projeto Final/ZKSIGEP1/WebContent/Relatorios/AtaResultadoEnsinoMedio.pdf";
		jasper = application.getRealPath("/Relatorios/AtaResultadoEnsinoMedio.jasper");
	...
	public void onSelect$turmaCombo(){
		...
		gerarPdfMedio.setDisabled(false); 
