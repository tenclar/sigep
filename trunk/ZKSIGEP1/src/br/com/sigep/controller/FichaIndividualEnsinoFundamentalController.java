...
public class FichaIndividualEnsinoFundamentalController extends GenericForwardComposer{
	...
	public void onClick$gerarPdfFundamental(Event e) throws InterruptedException, JRException, SQLException {
		...
		if (anoLetivoCombo.getSelectedIndex() == -1) {
			...
			caminho = application.getRealPath("/Relatorios/Ficha Individual Ensino Fundamental.jrxml");
			saida = "D:/Arquivos da Faculdade/Projeto Final/ZKSIGEP1/WebContent/Relatorios/Ficha Individual Ensino Fundamental.pdf";
			jasper = application.getRealPath("/Relatorios/Ficha Individual Ensino Fundamental.jasper");
