...
public class HistoricoController extends GenericForwardComposer{
	...
	public void onClick$gerarPdfHistorico(Event e) throws InterruptedException, JRException, SQLException {
		...
		if (anoLetivoCombo.getSelectedIndex() == -1) {
			...
			caminho = application.getRealPath("/Relatorios/Certificado de Conclusão.jrxml");
			saida = "D:/Arquivos da Faculdade/Projeto Final/ZKSIGEP1/WebContent/Relatorios/Certificado de Conclusão.pdf";
			jasper = application.getRealPath("/Relatorios/Certificado de Conclusão.jasper");
